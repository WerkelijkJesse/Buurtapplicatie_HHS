...
namespace Buurt_interactie_app_Semester3_WDPR.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            IEmailSender emailSender, BuurtAppContext context)
        {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new BuurtAppUser { UserName = Input.Email, Email = Input.Email, AnoNummer =  GenerateUniqueIdentifier(), Postcode = Input.Postcode, Naam = Input.Naam };

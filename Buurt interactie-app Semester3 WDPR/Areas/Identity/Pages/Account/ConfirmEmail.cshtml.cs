...
namespace Buurt_interactie_app_Semester3_WDPR.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmEmailModel : PageModel
    {
        ...
        public ConfirmEmailModel(UserManager<BuurtAppUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string code)
        {
            ...
            StatusMessage = result.Succeeded ? "Dankuwel voor het bevestigen. U kunt nu inloggen." : "Error bij het bevestigen van uw e-mail.";
            return Page();
        }
    }
}
